...
function Slider() {
  ...
  const [fins,setFins] = useState(false)
  ...
  return (
    ...
    >
      {fins && (
        datas.map((data) =>(
          <SwiperSlide key={data.id} className="h-screnn flex justify-center items-center">
          <div className={`w-full sm:w-[400px] mx-auto my-auto h-full  sm:h-[80%]  flex items-center justify-center`}>
            <div className="flex h-full   w-full sm:w-[90%] relative items-end justify-center">
              <div className="h-full  w-full  relative">
                ...
                <img className="h-full object-cover sm:rounded-md w-full" src={data.images[0]} />
                <div className="absolute left-0 bottom-0 w-full px-2 py-2">
                  ...
                  <div className="flex items-center justify-start">
                    ...
                    <p className="text-white ml-2">{data.brand}</p>
                  </div>
                </div>
              </div>
